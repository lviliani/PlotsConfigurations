...
TFile *f1 = TFile::Open("rootFile/plots_ggH2018_v7.root");
  ...
  h_total = (TH1F*)f1->Get("hww2l2v_13TeV/eta2/histo_ggH_hww");
  h_pass_singlEl = (TH1F*)f1->Get("hww2l2v_13TeV_withTrig_singleEl/eta2/histo_ggH_hww");
  h_pass_singlMu = (TH1F*)f1->Get("hww2l2v_13TeV_withTrig_singleMu/eta2/histo_ggH_hww");
  h_pass_ElMu = (TH1F*)f1->Get("hww2l2v_13TeV_withTrig_ElMu/eta2/histo_ggH_hww");
  h_pass_Trig = (TH1F*)f1->Get("hww2l2v_13TeV_withTrig/eta2/histo_ggH_hww");
...
//  pngFileName +=  "_efficiency.png";
  c->SaveAs("ggH_TriggerEff_Direct_eta2.png");
  c->Clear();
