...
TFile *f = TFile::Open("rootFile/plots_ggH2018_v7_TnPEff.root");
  ...
  h_total = (TH1F*)f->Get("hww2l2v_13TeV_em/pt2/histo_ggH_hww");
  h_pass_singlEl = (TH1F*)f->Get("hww2l2v_13TeV_em/pt2/histo_ggH_hww_singlEl");
  h_pass_singlMu = (TH1F*)f->Get("hww2l2v_13TeV_em/pt2/histo_ggH_hww_singlMu");
  h_pass_ElMu = (TH1F*)f->Get("hww2l2v_13TeV_em/pt2/histo_ggH_hww_ElMu");
  h_pass_Trig = (TH1F*)f->Get("hww2l2v_13TeV_em/pt2/histo_ggH_hww_Trig");
...
//}
  ...
  c->SaveAs("ggH_TriggerEff_fromMCTnP_pt2_em.png");
  c->Clear();

        delete c;

  h_total = (TH1F*)f->Get("hww2l2v_13TeV_me/pt2/histo_ggH_hww");
  h_pass_singlEl = (TH1F*)f->Get("hww2l2v_13TeV_me/pt2/histo_ggH_hww_singlEl");
  h_pass_singlMu = (TH1F*)f->Get("hww2l2v_13TeV_me/pt2/histo_ggH_hww_singlMu");
  h_pass_ElMu = (TH1F*)f->Get("hww2l2v_13TeV_me/pt2/histo_ggH_hww_ElMu");
  h_pass_Trig = (TH1F*)f->Get("hww2l2v_13TeV_me/pt2/histo_ggH_hww_Trig");
...
//}
  ...
  c->SaveAs("ggH_TriggerEff_fromMCTnP_pt2.png");
  c->Clear();
